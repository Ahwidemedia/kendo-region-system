...
ADD COLUMN `grade_actuel_organisation` VARCHAR(100) NULL AFTER `grade_actuel_lieux`,
...
ALTER TABLE `jkcf`.`licencies` ADD COLUMN `adresse` VARCHAR(800) NULL AFTER `lieu_naissance`;
...
CHANGE COLUMN `grade_actuel_id` `grade_actuel_id` INT(11) NOT NULL ,
CHANGE COLUMN `grade_actuel_lieu` `grade_actuel_lieu` VARCHAR(100) NOT NULL ,
CHANGE COLUMN `grade_actuel_organisation` `grade_actuel_organisation` VARCHAR(100) NOT NULL ,
CHANGE COLUMN `grade_actuel_date` `grade_actuel_date` DATE NOT NULL ;
