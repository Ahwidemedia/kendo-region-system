...
class PassagesController extends AppController
{
    ...
    public function view($id = null)
    {
        $passage = $this->Passages->get($id, [
            'contain' => ['Disciplines', 'Evenements', 'InscriptionPassages']
        ]);
    ...
    public function add()
    {
        ...
        $disciplines = $this->Passages->Disciplines->find('list', ['limit' => 200]);
        $evenements = $this->Passages->Evenements->find('list', ['limit' => 200]);
        $this->set(compact('passage', 'disciplines', 'evenements'));
        $this->set('_serialize', ['passage']);
    }
