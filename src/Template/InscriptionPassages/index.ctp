    ...
    <div class="center width-70">
        ...
        <table class="tableau-gris" style="margin-top:5px; border:solid 3px black" id="tabInscription">
            <tr>
                ...
                <td><?= $this->Form->text("numero_licence",['numero_licence' => 'numero_licence','label' => false, 'class'=>'nom-ind','style'=>'width:80%; height:2em', 'required' => true]) ?></td>
            </tr>
            <tr>
                <td>Nom</td>
                <td><?= $this->Form->text("nom",['name' => 'nom','label' => false, 'class'=>'nom-ind','style'=>'width:80%; height:2em', 'required' => true]) ?></td>
            <tr>
                <td>Prénom</td>
                <td><?= $this->Form->text("prenom",['name' => 'prenom','label' => false, 'class'=>'prenom-ind','style'=>'width:80%; height:2em', 'required' => true]) ?></td>
            </tr>
            <tr>
                <td>Sexe</td>
                <td><?= $this->Form->select("sexe", ['M'=>'M', 'F'=>'F'], ['empty' => ' ', 'name' => 'sexe[]','label' => false, 'class'=>'sexe-ind', 'required' => true]) ?></td>
            <tr>
            <tr style="border-top:solid 3px black; ">
                <td>Nationalité</td>
                <td><?= $this->Form->text("nationalite", ['name' => 'nationalite','label' => false, 'class'=>'nationalite-ind','style'=>'width:80%; height:2em']) ?></td>
            </tr>
            <tr>
                <td>Adresse</td>
                <td><?= $this->Form->text("adresse",[ 'name' => 'adresse','label' => false,'style'=>'width:80%; height:2em', 'class'=>'adresse-ind']) ?></td>
            </tr>
            <tr>
                <td>Téléphone</td>
                <td><?= $this->Form->text("telephone", ['name' => 'telephone','label' => false, 'class'=>'telephone-ind','style'=>'width:80%; height:2em']) ?></td>
            </tr>
            <tr>
                <td>Fax</td>
                <td><?= $this->Form->input("fax", ['name' => 'fax','label' => false, 'class'=>'fax-ind', 'style'=>'width:80%; height:2em']) ?></td>
            </tr>
            <tr>
                <td>Email</td>
                <td><?= $this->Form->input("email", ['name' => 'email','label' => false, 'class'=>'email-ind', 'style'=>'width:80%; height:2em']) ?></td>
            </tr>
            <tr style="border-top:solid 3px black; ">
                <td>Date de naissance</td>
                <td><?= $this->Form->input("date_naissance", ['name' => 'date_naissance','label' => false, 'class'=>'ddn-ind', 'style'=>'width:80%; height:2em', 'required' => true]) ?></td>
            </tr>
            <tr>
                <td>Lieu de naissance</td>
                <td><?= $this->Form->input("lieu_naissance", ['name' => 'lieu_naissance','label' => false, 'class'=>'ldn-ind', 'style'=>'width:80%; height:2em']) ?></td>
            </tr>
            <tr style="border-top:solid 3px black; ">
                <td>Grade précédent</td>
                <td><?= $this->Form->input("grade_id", ['name' => 'grade_actuel_id','label' => false, 'class'=>'grade-ind', 'style'=>'width:80%; height:2em', 'required' => true,  ['options' => $grades]]) ?></td>
            </tr>
            <tr>
                <td>Obtenu le</td>
                <td><?= $this->Form->input("grade_actuel_date", ['name' => 'grade_actuel_date','label' => false, 'class'=>'obteny-ind', 'style'=>'width:80%; height:2em', 'required' => true]) ?></td>
            </tr>
            <tr>
                <td>Lieu d'obtention</td>
                <td><?= $this->Form->input("grade_actuel_lieu", ['name' => 'grade_actuel_lieu','label' => false, 'class'=>'lieu-obtention-ind', 'style'=>'width:80%; height:2em', 'required' => true]) ?></td>
            </tr>
            <tr>
                <td>Organisation</td>
                <td><?= $this->Form->input("grade_actuel_organisation", ['name' => 'grade_actuel_organisation','label' => false, 'class'=>'organisation-ind', 'style'=>'width:80%; height:2em', 'required' => true]) ?></td>
            </tr>
            <tr style="border-top:solid 3px black; ">
                <td>Grade présenté</td>
                <td><?= $this->Form->input("grade_id", ['name' => 'grade_presente_id','label' => false, 'class'=>'grade-ind', 'style'=>'width:80%; height:2em', 'required' => true,  ['options' => $grades]]) ?></td>
            </tr>            
        </table>
