...
<div class="padding-50">
	...
	<div class="center width-70">
		...
		<p class="center padding-1">
			Responsable Club :
			<?php echo $this->Form->input("responsable_club", ['label'=>false,'required'=>'required']); ?>
		</p>

		<p class="center padding-1">Responsable Inscriptions (si différent) :
			<?php echo $this->Form->input("responsable_inscriptions", ['label'=>false]); ?>
		</p>
...
if(age < 2004) { if($(td).prev("td").prev("td").children().val()=='M' ) { if(age==2003 || age==2002) { $(td).next("td").children(".categorie").text( "Cadet" ); } else if(age==2001 || age==2000 || age==1999) { $(td).next("td").children(".categorie").text( "Junior" ); } else if(age < '1999' ) { if( $(td).prev("td").children().val() < '3' ) { $(td).next("td").children(".categorie").text( "Honneur" ); } else if( $(td).prev("td").children().val()> '2') {
	...
	if(sexe == 'M' && age < 2002 && (grade==1 || grade==2)) { $(td).next("td").children(".surclassement-grade").addClass('display-block'); $(td).next("td").children(".surclassement-grade").removeClass('display-none'); } else { $(td).next("td").children(".surclassement-grade").addClass('display-none') $(td).next("td").children(".surclassement-grade").removeClass('display-block'); } } } // Pour les grades----------------------------- if (x.value> -10 && x.value < 10){ var td=x.parentElement; grade=x.value; age=$(td).next("td").children().children(".age-input").val(); sexe=$(td).prev("td").children(".sexe").val(); if(age !=='' && sexe !=='' && grade !=='' ) { if(age < '1999' ) { if(sexe=='M' && grade < '3' ) { $(td).next("td").next("td").children(".categorie").text( "Honneur" ); } else if (sexe=='M' && grade> '2') {
			...
			else if(age < '1999' ) { if(grade> 2) {

				$(td).next("td").next("td").next("td").children(".categorie").text( "Excellence" );

				} else if(grade < 3) { $(td).next("td").next("td").next("td").children(".categorie").text( "Honneur" ); } } } if(age !=='' && sexe !=='' && grade !=='' ) { if(x.value=='F' ) { if(age=='2010' || age=='2011' ) { $(td).next("td").children(".categorie").text( "Poussin" ); } else if(age=='2009 ' || age=='2008' ) { $(td).next("td").children(".categorie").text( "Samouraï" ); } else if(age=='2007' || age=='2006' ) { $(td).next("td").children(".categorie").text( "Benjamin" ); } else if(age=='2005' || age=='2004' ) { $(td).next("td").children(".categorie").text( "Minime" ); } else if(age=='2003' || age=='2002' || age=='2001' ) { $(td).next("td").next("td").next("td").children(".categorie").text( "Espoir" ); } else if(age < '2001' ) { $(td).next("td").next("td").next("td").children(".categorie").text( "Femme" ); } } } if(sexe=='M' && age < '2002' && (grade=='1' || grade=='2' )) { $(td).next("td").next("td").next("td").children(".surclassement-grade").addClass('display-block'); $(td).next("td").next("td").next("td").children(".surclassement-grade").removeClass('display-none'); } else { $(td).next("td").next("td").next("td").children(".surclassement-grade").addClass('display-none') $(td).next("td").next("td").next("td").children(".surclassement-grade").removeClass('display-block'); } if(((age=='2001' || age=='2000' || age=='1999' ) && sexe=='M' ) || ((age=='2001' || age=='2002' || age=='2003' ) && sexe=='F' )) { $(td).next("td").next("td").next("td").children(".surclassement-age").addClass('display-block') $(td).next("td").next("td").next("td").children(".surclassement-age").removeClass('display-none'); } else { $(td).next("td").next("td").next("td").children(".surclassement-age").addClass('display-none') $(td).next("td").next("td").next("td").children(".surclassement-age").removeClass('display-block'); } } } } function surclassement(x) { if($(x).is(':checked')) { if($(x).parent().prev(".surclassement-age").hasClass("display-block")) { $(x).parent().prev(".surclassement-age").children().prop('checked', true); } } } function certif(x) { if(x.value < '2018' ) { $(x).parent().next(".certif").addClass("display-block"); } } function newclub(x) { if($(x).is(':checked')) { $(".newclub").addClass("display-block"); } } <?php $this->Html->scriptEnd(); ?>
