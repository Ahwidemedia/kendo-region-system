...
class InscriptionPassagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'commentaire' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'passage_inscripyion_fk_idx' => ['type' => 'index', 'columns' => ['passage_id'], 'length' => []],
            'licencie_inscription_fk_idx' => ['type' => 'index', 'columns' => ['licencie_id'], 'length' => []],
            'grade_inscription_fk_idx' => ['type' => 'index', 'columns' => ['grade_presente_id'], 'length' => []],
            'user_inscription_fk_idx' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'grade_presente_id' => 1,
            'user_id' => 1,
            'created' => '2018-12-04 10:57:18',
            'modified' => '2018-12-04 10:57:18',
            'club_id' => 1
        ],
    ];
}
